...
|---|---|---|---|---|---|
| [2.0.1](https://github.com/Gyovana-Moriyama/dgm-2026.1/blob/e3_delivery/projects/ecgpcx-ray/notebooks/2.0.1-finetune_chexnet_synthetic.ipynb) | CycleGAN | All H→P | 0.6863 | 0.0135 | 0.5207 |
| [2.0.2](https://github.com/Gyovana-Moriyama/dgm-2026.1/blob/e3_delivery/projects/ecgpcx-ray/notebooks/2.0.2-finetune_chexnet_synthetic_only_flipped.ipynb) | CycleGAN | Flipped only | 0.6659 | 0.0132 | 0.6676 |
| [2.1.1](https://github.com/Gyovana-Moriyama/dgm-2026.1/blob/e3_delivery/projects/ecgpcx-ray/notebooks/2.1.1-finetune_chexnet_synthetic_cvae.ipynb) | CVAE | All H→P | 0.6731 | 0.0074 | 0.5630 |
| [2.1.2](https://github.com/Gyovana-Moriyama/dgm-2026.1/blob/e3_delivery/projects/ecgpcx-ray/notebooks/2.1.2-finetune_chexnet_synthetic_cvae_only_flipped.ipynb) | CVAE | Flipped only | 0.6699 | 0.0109 | 0.7146 |
| [1.6](https://github.com/Gyovana-Moriyama/dgm-2026.1/blob/e3_delivery/projects/ecgpcx-ray/notebooks/1.6-chexnet_arbiter.ipynb) | CheXNet original | — | **0.7423** | **0.0170** | 0.6296 |
...
The classifier experiments revealed a consistent pattern: training from scratch on the NIH pneumonia subset is fundamentally limited by the severity of class imbalance (~0.5% positive rate) and the small number of real pneumonia cases available. Neither architectural choices (SimpleCNN vs. frozen backbones) nor data augmentation strategies were sufficient to overcome this bottleneck. The fine-tuning experiments further showed that synthetic images from both CVAE and CycleGAN do not provide the discriminative signal needed to improve a classifier beyond the frozen CheXNet baseline. This reinforces a key distinction for this project: generating a convincing counterfactual image is not the same as generating a diagnostically informative one. CheXNet, pre-trained on 112K real chest X-rays, remains the most reliable oracle available and its adoption as a fixed judge reflects a deliberate choice to separate the evaluation signal from the generative models under assessment.
